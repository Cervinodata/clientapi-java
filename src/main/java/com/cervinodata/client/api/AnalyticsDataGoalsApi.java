...
public class AnalyticsDataGoalsApi {
    ...
    /**
     * Build call for getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay
     ...
     */
    public okhttp3.Call getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayCall(List<String> organisationUuids, LocalDate fromDate, String dateFormat, String format, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/data/analytics-goal-report-per-device-per-channel-group-per-organisation-per-view-per-day/{organisationUuids}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayValidateBeforeCall(List<String> organisationUuids, LocalDate fromDate, String dateFormat, String format, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'organisationUuids' is set
        if (organisationUuids == null) {
            throw new ApiException("Missing the required parameter 'organisationUuids' when calling getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay(Async)");
        }
        

        okhttp3.Call localVarCall = getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayCall(organisationUuids, fromDate, dateFormat, format, _callback);
        return localVarCall;
     ...
     */
    public String getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay(List<String> organisationUuids, LocalDate fromDate, String dateFormat, String format) throws ApiException {
        ApiResponse<String> localVarResp = getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayWithHttpInfo(organisationUuids, fromDate, dateFormat, format);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayWithHttpInfo(List<String> organisationUuids, LocalDate fromDate, String dateFormat, String format) throws ApiException {
        okhttp3.Call localVarCall = getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayValidateBeforeCall(organisationUuids, fromDate, dateFormat, format, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Return analytics goal report per device per channel group per organisation per view per day (asynchronously)
     * Analytics goal report per device per channel group per organisation per view per day
     * @param organisationUuids Organisation uuids (required)
     * @param fromDate From date (optional)
     * @param dateFormat Outputted date format (optional)
     ...
     */
    public okhttp3.Call getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayAsync(List<String> organisationUuids, LocalDate fromDate, String dateFormat, String format, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayValidateBeforeCall(organisationUuids, fromDate, dateFormat, format, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
