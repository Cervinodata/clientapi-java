...
/**
 * API tests for AnalyticsDataProductMetricsApi
 */
@Disabled
public class AnalyticsDataProductMetricsApiTest {

    private final AnalyticsDataProductMetricsApi api = new AnalyticsDataProductMetricsApi();
     ...
     */
    @Test
    public void getGA4ReportPerProductNamePerOrganisationPerPropertyPerWeekTest() throws ApiException {
        List<String> organisationUuids = null;
        String response = api.getGA4ReportPerProductNamePerOrganisationPerPropertyPerWeek(organisationUuids);
     ...
     */
    @Test
    public void getGA4ReportPerProductSkuPerOrganisationPerPropertyPerWeekTest() throws ApiException {
        List<String> organisationUuids = null;
        String response = api.getGA4ReportPerProductSkuPerOrganisationPerPropertyPerWeek(organisationUuids);
        // TODO: test validations
    }
